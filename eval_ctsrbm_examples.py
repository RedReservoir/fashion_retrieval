...
def compute_closest_idxs(
    ...
    desired_cons_img_zidxs = src.utils.array.compute_zidxs(cons_img_idxs, desired_cons_img_idxs)
    desired_cons_img_zzidxs = np.arange(num_desired_cons_imgs)
    
    desired_cons_img_zidxs_chunk_gen = src.utils.chunk.chunk_partition_size(desired_cons_img_zidxs, cons_imgs_chunk_size)
    desired_cons_img_zzidxs_chunk_gen = src.utils.chunk.chunk_partition_size(desired_cons_img_zzidxs, cons_imgs_chunk_size)    
...
if __name__ == "__main__":
    ...
    if len(train_desired_cons_img_idxs) != 0:
        ...
        train_desired_cons_img_zidxs = src.utils.array.compute_zidxs(train_cons_img_idxs, train_desired_cons_img_idxs)
    ...
    if len(val_desired_cons_img_idxs) != 0:
        ...
        val_desired_cons_img_zidxs = src.utils.array.compute_zidxs(val_cons_img_idxs, val_desired_cons_img_idxs)
    ...
    if len(test_desired_cons_img_idxs) != 0:
        ...
        test_desired_cons_img_zidxs = src.utils.array.compute_zidxs(test_cons_img_idxs, test_desired_cons_img_idxs)
