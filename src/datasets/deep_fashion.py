...
class CatAttrPredBM(Dataset):
    ...
    def _num_bytes(self):
        ...
        num_bytes += src.utils.memory.get_num_bytes(self._dataset_dir)
        num_bytes += src.utils.memory.get_num_bytes(self._img_transform)

        num_bytes += src.utils.memory.get_num_bytes(self._train_mask_idxs)
        num_bytes += src.utils.memory.get_num_bytes(self._test_mask_idxs)
        num_bytes += src.utils.memory.get_num_bytes(self._val_mask_idxs)

        num_bytes += src.utils.memory.get_num_bytes(self._category_name_list)
        num_bytes += src.utils.memory.get_num_bytes(self._supcategory_idx_list)
        num_bytes += src.utils.memory.get_num_bytes(self._supcategory_name_list)

        num_bytes += src.utils.memory.get_num_bytes(self._attribute_name_list)
        num_bytes += src.utils.memory.get_num_bytes(self._supattribute_idx_list)
        num_bytes += src.utils.memory.get_num_bytes(self._supattribute_name_list)

        num_bytes += src.utils.memory.get_num_bytes(self._list_eval_partition_cursor_list)
        num_bytes += src.utils.memory.get_num_bytes(self._image_bbox_cursor_list)
        num_bytes += src.utils.memory.get_num_bytes(self._image_category_cursor_list)
        num_bytes += src.utils.memory.get_num_bytes(self._image_attribute_cursor_list)

        num_bytes += src.utils.memory.get_num_bytes(self._list_eval_partition_file)
        num_bytes += src.utils.memory.get_num_bytes(self._image_bbox_file)
        num_bytes += src.utils.memory.get_num_bytes(self._image_category_file)
        num_bytes += src.utils.memory.get_num_bytes(self._image_attribute_file)

        num_bytes += src.utils.memory.get_num_bytes(self._list_eval_partition_file_lock)
        num_bytes += src.utils.memory.get_num_bytes(self._image_bbox_file_lock)
        num_bytes += src.utils.memory.get_num_bytes(self._image_category_file_lock)
        num_bytes += src.utils.memory.get_num_bytes(self._image_attribute_file_lock)
...
class ConsToShopClothRetrBM(Dataset):
    ...
    def _num_bytes(self):
        ...
        num_bytes += src.utils.memory.get_num_bytes(self._list_eval_partition_aux_idxs_cursor_list)
        num_bytes += src.utils.memory.get_num_bytes(self._list_eval_partition_neg_aux_idxs_cursor_list)
        num_bytes += src.utils.memory.get_num_bytes(self._image_filename_bbox_cursor_list)
        num_bytes += src.utils.memory.get_num_bytes(self._item_attribute_cursor_list)

        num_bytes += src.utils.memory.get_num_bytes(self._list_eval_partition_aux_idxs_file)
        num_bytes += src.utils.memory.get_num_bytes(self._list_eval_partition_neg_aux_idxs_file)
        num_bytes += src.utils.memory.get_num_bytes(self._image_bbox_file)
        num_bytes += src.utils.memory.get_num_bytes(self._item_attribute_file)

        num_bytes += src.utils.memory.get_num_bytes(self._list_eval_partition_aux_idxs_file_lock)
        num_bytes += src.utils.memory.get_num_bytes(self._list_eval_partition_neg_aux_idxs_file_lock)
        num_bytes += src.utils.memory.get_num_bytes(self._image_bbox_file_lock)
        num_bytes += src.utils.memory.get_num_bytes(self._item_attribute_file_lock)
        
        num_bytes += src.utils.memory.get_num_bytes(self._list_eval_partition_aux_idxs_filename)
        num_bytes += src.utils.memory.get_num_bytes(self._list_eval_partition_neg_aux_idxs_filename)
    ...
    def _is_pickable(self):
        ...
        print("  ", src.utils.pkl.pickle_test(self._dataset_dir))
        print("self._img_transform")
        print("  ", src.utils.pkl.pickle_test(self._img_transform))

        print("self._train_mask_idxs")
        print("  ", src.utils.pkl.pickle_test(self._train_mask_idxs))
        print("self._test_mask_idxs")
        print("  ", src.utils.pkl.pickle_test(self._test_mask_idxs))
        print("self._val_mask_idxs")
        print("  ", src.utils.pkl.pickle_test(self._val_mask_idxs))

        print("self._attribute_name_list")
        print("  ", src.utils.pkl.pickle_test(self._attribute_name_list))
        print("self._supattribute_idx_list")
        print("  ", src.utils.pkl.pickle_test(self._supattribute_idx_list))
        print("self._supattribute_name_list")
        print("  ", src.utils.pkl.pickle_test(self._supattribute_name_list))

        print("self._list_eval_partition_aux_idxs_cursor_list")
        print("  ", src.utils.pkl.pickle_test(self._list_eval_partition_aux_idxs_cursor_list))
        print("self._list_eval_partition_neg_aux_idxs_cursor_list")
        print("  ", src.utils.pkl.pickle_test(self._list_eval_partition_neg_aux_idxs_cursor_list))
        print("self._image_filename_bbox_cursor_list")
        print("  ", src.utils.pkl.pickle_test(self._image_filename_bbox_cursor_list))
        print("self._item_attribute_cursor_list")
        print("  ", src.utils.pkl.pickle_test(self._item_attribute_cursor_list))

        print("self._list_eval_partition_aux_idxs_file")
        print("  ", src.utils.pkl.pickle_test(self._list_eval_partition_aux_idxs_file))
        print("self._list_eval_partition_neg_aux_idxs_file")
        print("  ", src.utils.pkl.pickle_test(self._list_eval_partition_neg_aux_idxs_file))
        print("self._image_bbox_file")
        print("  ", src.utils.pkl.pickle_test(self._image_bbox_file))
        print("self._item_attribute_file")
        print("  ", src.utils.pkl.pickle_test(self._item_attribute_file))

        print("self._list_eval_partition_aux_idxs_file_lock")
        print("  ", src.utils.pkl.pickle_test(self._list_eval_partition_aux_idxs_file_lock))
        print("self._list_eval_partition_neg_aux_idxs_file_lock")
        print("  ", src.utils.pkl.pickle_test(self._list_eval_partition_neg_aux_idxs_file_lock))
        print("self._image_bbox_file_lock")
        print("  ", src.utils.pkl.pickle_test(self._image_bbox_file_lock))
        print("self._item_attribute_file_lock")
        print("  ", src.utils.pkl.pickle_test(self._item_attribute_file_lock))

        print("self._list_eval_partition_aux_idxs_filename")
        print("  ", src.utils.pkl.pickle_test(self._list_eval_partition_aux_idxs_filename))
        print("self._list_eval_partition_neg_aux_idxs_filename")
        print("  ", src.utils.pkl.pickle_test(self._list_eval_partition_neg_aux_idxs_filename))
...
class ConsToShopClothRetrBM_NEW(Dataset):
    ...
    def _num_bytes(self):
        ...
        num_bytes += src.utils.memory.get_num_bytes(self._img_1_uid_codes_arr)
        num_bytes += src.utils.memory.get_num_bytes(self._img_2_uid_codes_arr)
        num_bytes += src.utils.memory.get_num_bytes(self._img_3_uid_codes_arr)
    ...
    def _is_pickable(self):
        ...
        print("  ", src.utils.pkl.pickle_test(self._img_1_uid_codes_arr))
        print("self._img_2_uid_codes_arr")
        print("  ", src.utils.pkl.pickle_test(self._img_2_uid_codes_arr))
        print("self._img_3_uid_codes_arr")
        print("  ", src.utils.pkl.pickle_test(self._img_3_uid_codes_arr))
