...
class CatAndAttrPredBmkDataset(Dataset):
    ...
    def _num_bytes(self):
        ...
        num_bytes += utils.mem.get_num_bytes(self._img_subdir_name_inv_dict)
        ...
        num_bytes += utils.mem.get_num_bytes(self._img_cat_codes_arr)
    ...
    def _is_pickable(self):
        ...
        print("  ", utils.pkl.pickle_test(self._img_subdir_name_inv_dict))
        ...
        print("  ", utils.pkl.pickle_test(self._img_cat_codes_arr))
