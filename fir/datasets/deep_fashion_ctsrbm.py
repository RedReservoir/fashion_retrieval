...
class ConsToShopClothRetrBmkDataset(Dataset):
    ...
    def _num_bytes(self):
        ...
        num_bytes += fir.utils.mem.get_num_bytes(self._dataset_dirname)
        num_bytes += fir.utils.mem.get_num_bytes(self._img_transform)
        num_bytes += fir.utils.mem.get_num_bytes(self._neg_img_filename_list_id)

        num_bytes += fir.utils.mem.get_num_bytes(self._split_num_mask)

        num_bytes += fir.utils.mem.get_num_bytes(self._cloth_type_list)
        num_bytes += fir.utils.mem.get_num_bytes(self._cloth_subtype_llist)
        num_bytes += fir.utils.mem.get_num_bytes(self._cloth_type_inv_dict)
        num_bytes += fir.utils.mem.get_num_bytes(self._cloth_subtype_inv_dict_list)

        num_bytes += fir.utils.mem.get_num_bytes(self._num_imgs)
        num_bytes += fir.utils.mem.get_num_bytes(self._num_img_pairs)

        num_bytes += fir.utils.mem.get_num_bytes(self._img_filename_codes_arr)
        num_bytes += fir.utils.mem.get_num_bytes(self._img_bbox_codes_arr)

        num_bytes += fir.utils.mem.get_num_bytes(self._img_anc_uid_codes_arr)
        num_bytes += fir.utils.mem.get_num_bytes(self._img_pos_uid_codes_arr)
        num_bytes += fir.utils.mem.get_num_bytes(self._img_neg_uid_codes_arr)
    ...
    def _is_pickable(self):
        ...
        print("  ", fir.utils.pkl.pickle_test(self._dataset_dirname))
        print("self._img_transform")
        print("  ", fir.utils.pkl.pickle_test(self._img_transform))
        print("self._neg_img_filename_list_id")
        print("  ", fir.utils.pkl.pickle_test(self._neg_img_filename_list_id))

        print("self._split_num_mask")
        print("  ", fir.utils.pkl.pickle_test(self._split_num_mask))

        print("self._cloth_type_list")
        print("  ", fir.utils.pkl.pickle_test(self._cloth_type_list))
        print("self._cloth_subtype_llist")
        print("  ", fir.utils.pkl.pickle_test(self._cloth_subtype_llist))
        print("self._cloth_type_inv_dict")
        print("  ", fir.utils.pkl.pickle_test(self._cloth_type_inv_dict))
        print("self._cloth_subtype_inv_dict_list")
        print("  ", fir.utils.pkl.pickle_test(self._cloth_subtype_inv_dict_list))
        
        print("self._num_imgs")
        print("  ", fir.utils.pkl.pickle_test(self._num_imgs))
        print("self._num_img_pairs")
        print("  ", fir.utils.pkl.pickle_test(self._num_img_pairs))
        
        print("self._img_filename_codes_arr")
        print("  ", fir.utils.pkl.pickle_test(self._img_filename_codes_arr))
        print("self._img_bbox_codes_arr")
        print("  ", fir.utils.pkl.pickle_test(self._img_bbox_codes_arr))

        print("self._img_anc_uid_codes_arr")
        print("  ", fir.utils.pkl.pickle_test(self._img_anc_uid_codes_arr))
        print("self._img_pos_uid_codes_arr")
        print("  ", fir.utils.pkl.pickle_test(self._img_pos_uid_codes_arr))
        print("self._img_neg_uid_codes_arr")
        print("  ", fir.utils.pkl.pickle_test(self._img_neg_uid_codes_arr))
...
class ConsToShopClothRetrBmkImageLoader(Dataset):
    ...
    def _num_bytes(self):
        ...
        num_bytes += fir.utils.mem.get_num_bytes(self._split_num_mask)
        num_bytes += fir.utils.mem.get_num_bytes(self._domain_num_mask)
    ...
    def _is_pickable(self):
        ...
        print("  ", fir.utils.pkl.pickle_test(self._domain_num_mask))
