...
class ConsToShopClothRetrBmkDataset(Dataset):
    ...
    def _num_bytes(self):
        ...
        num_bytes += utils.mem.get_num_bytes(self._split_num_mask)
        ...
        num_bytes += utils.mem.get_num_bytes(self._img_anc_uid_codes_arr)
        num_bytes += utils.mem.get_num_bytes(self._img_pos_uid_codes_arr)
        num_bytes += utils.mem.get_num_bytes(self._img_neg_uid_codes_arr)
    ...
    def _is_pickable(self):
        ...
        print("  ", utils.pkl.pickle_test(self._split_num_mask))
        ...
        print("  ", utils.pkl.pickle_test(self._img_anc_uid_codes_arr))
        print("self._img_pos_uid_codes_arr")
        print("  ", utils.pkl.pickle_test(self._img_pos_uid_codes_arr))
        print("self._img_neg_uid_codes_arr")
        print("  ", utils.pkl.pickle_test(self._img_neg_uid_codes_arr))
...
class ConsToShopClothRetrBmkImageLoader(Dataset):
    ...
    def _num_bytes(self):
        ...
        num_bytes += utils.mem.get_num_bytes(self._split_num_mask)
        num_bytes += utils.mem.get_num_bytes(self._domain_num_mask)
    ...
    def _is_pickable(self):
        ...
        print("  ", utils.pkl.pickle_test(self._domain_num_mask))
