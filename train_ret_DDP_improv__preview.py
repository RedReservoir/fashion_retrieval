...
def execute_stage_1_DDP(
    ...
    log_filename = "train_ret_DDP_improv__preview_logs.txt_logs.txt"
    ...
    backbone_image_transform = get_backbone_image_transform(backbone_class)
    ...
    backbone = create_backbone(exp_params["settings"]["backbone"]["class"])
